	    			...
	    			<div class="card-content p-3">
					 ...
					 <div class="card-title text-uppercase text-center py-3">Form Pendaftaran</div>
					    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <span style="color: red; font-size: 10px;">* Isi Dengan Email Yang aktif</span>
                            <div class="form-group">

                                <div class="position-relative has-icon-left">
                                    <label for="exampleInputEmailId" class="sr-only">Alamat Email</label>
                                    <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Alamat email">
                            ...
                            <span style="color: red; font-size: 10px;">* Isi Dengan No Wa yang dapat dihubungi</span>
                            <div class="form-group">
                                <div class="position-relative has-icon-left">
