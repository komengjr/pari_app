    ...
    <div class="container-fluid">
     <!-- Breadcrumb-->
        <div class="row pt-2 pb-2">
            <div class="col-sm">
                <h4 class="page-title">Form Test</h4>
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javaScript:void();">Home</a></li>
                <li class="breadcrumb-item"><a href="javaScript:void();">Forms</a></li>
                <li class="breadcrumb-item active" aria-current="page">Form Test</li>
                </ol>
            </div>
            <div class="col-sm-3">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="wizard-validation-form" action="{{ url('simpandatapretest', []) }}" method="POST">
                          @csrf
                            <div>
                                <h3>Panduan Test</h3>
                                <section>
                                    ...
                                    <div class="form-group">
                                        <label for="password2">3. Ketika Sudah Klik Selanjutnya Waktu akan Berjalan</label>
                                    </div>
                                    <div class="form-group">
